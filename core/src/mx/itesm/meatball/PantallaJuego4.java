 ...
 */
public class PantallaJuego4 implements Screen {
    ...
    private void cargarRecursos() {
        ...
        assetManager.load("MapaBoss2.tmx", TiledMap.class);  // Cargar info del mapa
        // Cargar de albondiga
        ...
        assetManager.load("spriteRata.png",Texture.class);
    ...
    private void crearObjetos() {
        ...
        mapa = assetManager.get("MapaBoss2.tmx");
        ...
        texturaPersonaje = assetManager.get("PugCorrer" +
                ".png");
        texturaFondo=assetManager.get("sprite poder quesuno.png");
        ...
        textturakitty=assetManager.get("spriteRata.png");
        Kitty= new Enemy(textturakitty,5,1);
    ...
    public void dispose() {
        ...
        assetManager.unload("MapaBoss2.tmx");  // Cargar info del mapa
        assetManager.unload("PugCorrer.png");    // Cargar de albondiga
        // Texturas de los botones
        assetManager.unload("spriteRata.png");
