 ...
 */
public class pantallaAlbondi implements Screen {
    ...
    public pantallaAlbondi(Principal principal) {
    ...
    private void cargaTexturasSprites() {
        texturaFondo=new Texture(Gdx.files.internal("Imagen principalFINAL_ESCALADA.jpg"));
